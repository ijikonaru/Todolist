...
class _UpdatePageState extends State<UpdatePage> {
  ...
  Future updateTodo() async {
    //var url = Uri.https('fe71-49-228-247-243.ngrok.io', '/api/update-todolist');
    var url = Uri.http('192.168.31.228:8000', '/api/update-todolist/$_v1');
  ...
  Future deleteTodo() async {
    var url = Uri.http('192.168.31.228:8000', '/api/delete-todolist/$_v1');
    Map<String, String> header = {"Content-type": "application/json"};
